...
# 1-(weighting/weighting^recording_impact) # this used to be 1/() but this has the opposite effect as intended if the weighting is between 0-1
# this will be wrong if the weighting > 10

effort_raster*(1-recording_impact)
