...
plot(raster::weighted.mean(dec_fls[[3]], preds), col=viridis(50))
points(x = spdf$lon, y = spdf$lat, col = 'red', pch = 20, cex=0.5)

```

```{r}
?setdiff
rm(list=setdiff(ls(), c("dec_fls", "preds", "var", "spdf")))
